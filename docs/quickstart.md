...
Open `http://<host>:8000/ui/` in a browser, enter your API key once, and you'll see all known jobs with live CPU/metrics sparklines. The **Launch** tab lets you submit jobs from the browser — select a GPU, mount volumes, pass environment variables, and watch the job appear in the **Monitor** tab.
